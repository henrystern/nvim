...
return {
  ...
  md.Ar_math("([^\\])lim", fmta("<>\\lim_{<>\\ \\to\\ <>}", { l(l.CAPTURE1), i(1), i(2) })),
  md.b_math("lim", fmta("\\lim_{<> \\to <>}", { i(1), i(2) })),
  md.Ar_math("([^\\])sum", fmta("<>\\sum_{<>}^{<>}", { l(l.CAPTURE1), i(1), i(2) })),
  md.b_math("sum", fmta("\\sum_{<>}^{<>}", { i(1), i(2) })),
  md.Ar_math("([^\\])prod", fmta("<>\\prod_{<>}^{<>}", { l(l.CAPTURE1), i(1), i(2) })),
  md.b_math("prod", fmta("\\prod_{<>}^{<>}", { i(1), i(2) })),
  md.Ar_math("([^\\])part", fmta("<>\\frac{\\partial <>}{\\partial <>}", { l(l.CAPTURE1), i(1), i(2) })),
  md.b_math("part", fmta("\\frac{\\partial <>}{\\partial <>}", { i(1), i(2) })),
