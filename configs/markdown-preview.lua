...
vim.g.mkdp_markdown_css = vim.fn.stdpath "config" .. "/lua/custom/runtime/data/markdown_preview/styles.css"
vim.g.mkdp_highlight_css = vim.fn.stdpath "config" .. "/lua/custom/runtime/data/markdown_preview/highlights.css"
