...
return {
  ...
  md.Ar_math("(.*%))vec", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "(", ")"}, "%s\\vec{%s}" }}) })),
  md.Ar_math("(.*%})vec", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "{", "}"}, "%s\\vec{%s}" }}) })),
  md.Ar_math("(.*%])vec", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "[", "]"}, "%s\\vec{%s}" }}) })),
  ...
  md.Ar_math("(.*%))bar", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "(", ")"}, "%s\\overline{%s}" }}) })),
  md.Ar_math("(.*%})bar", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "{", "}"}, "%s\\overline{%s}" }}) })),
  md.Ar_math("(.*%])bar", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "[", "]"}, "%s\\overline{%s}" }}) })),
  md.Ar_math("(.*%))hat", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "(", ")"}, "%s\\hat{%s}" }}) })),
  md.Ar_math("(.*%})hat", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "{", "}"}, "%s\\hat{%s}" }}) })),
  md.Ar_math("(.*%])hat", fmta("<>", { f(math_utils.format_group, {}, { user_args = { { "[", "]"}, "%s\\hat{%s}" }}) })),
  md.Ar_math("(.*%))/", fmta("<>{<>}", { f(math_utils.format_group, {}, { user_args = { { "(", ")"}, "%s\\frac{%s}" }}), i(1) })),
  md.Ar_math("(.*%})/", fmta("<>{<>}", { f(math_utils.format_group, {}, { user_args = { { "{", "}"}, "%s\\frac{%s}" }}), i(1) })),
  md.Ar_math("(.*%])/", fmta("<>{<>}", { f(math_utils.format_group, {}, { user_args = { { "[", "]"}, "%s\\frac{%s}" }}), i(1) })),
  ...
  md.Ar_math("([^\\])int", fmta("<>\\int_{<>}^{<>}", { l(l.CAPTURE1), i(1), i(2) })),
  ...
  md.Ar_math("([^\\])QED", fmta("<>\\blacksquare \\quad ", { l(l.CAPTURE1) })),
  ...
  md.b_math("int", fmta("\\int_{<>}^{<>}", { i(1), i(2) })),
